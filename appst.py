...
base = pd.read_excel('/content/drive/MyDrive/Relatórios_20222/Desempenho/Base 13102022v.xlsx')
base.dropna(inplace=True)

#Para importar a base de dados sem remover as linhas que têm espaço vazio:
base0 = pd.read_excel('/content/drive/MyDrive/Relatórios_20222/Desempenho/Base 13102022v.xlsx')
